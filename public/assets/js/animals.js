...
const getAnimals = (formData = {}) => { //formData = {} if undefined (not passed in function call)
  let queryUrl = '/api/animals?';

  Object.entries(formData).forEach(([key, value]) => { //Object.entries turns object into an array of keys/pairs
    queryUrl += `${key}=${value}&`;
  });
